Na podstawie informacji z wykładu i kodów ze strony (m.in. http://pkapust.iis.p.lodz.pl/HTML5/Samples/Canvas/paint.html) zrobić aplikację w stylu Paint z następującymi funkcjami:
